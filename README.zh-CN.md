...
├── templates/             # 七个世界的正式模板，各有英文（无后缀）/ 日文（-jp）/ 中文（-zh）三版
│   ├── wuwu/              # 雾坞镇（英文）
│   ├── wuwu-jp/           # 雾坞镇（日文）
│   ├── wuwu-zh/           # 雾坞镇（中文）
│   └── ...                # 完整清单见下方三语入口
...
| 世界 | English | 日本語 | 中文 |
|---|---|---|---|
| 雾坞镇 | [`wuwu`](templates/wuwu/) | [`wuwu-jp`](templates/wuwu-jp/) | [`wuwu-zh`](templates/wuwu-zh/) |
| 福尔摩斯 | [`whitechapel`](templates/whitechapel/) | [`whitechapel-jp`](templates/whitechapel-jp/) | [`whitechapel-zh`](templates/whitechapel-zh/) |
| 分歧线 | [`divergence`](templates/divergence/) | [`divergence-jp`](templates/divergence-jp/) | [`divergence-zh`](templates/divergence-zh/) |
| 初雪电台 | [`first-snow`](templates/first-snow/) | [`first-snow-jp`](templates/first-snow-jp/) | [`first-snow-zh`](templates/first-snow-zh/) |
| 魔法学院 | [`magic-academy`](templates/magic-academy/) | [`magic-academy-jp`](templates/magic-academy-jp/) | [`magic-academy-zh`](templates/magic-academy-zh/) |
| 未写之门 | [`unwritten-door`](templates/unwritten-door/) | [`unwritten-door-jp`](templates/unwritten-door-jp/) | [`unwritten-door-zh`](templates/unwritten-door-zh/) |
| 月下之誓 | [`moonlit-contract`](templates/moonlit-contract/) | [`moonlit-contract-jp`](templates/moonlit-contract-jp/) | [`moonlit-contract-zh`](templates/moonlit-contract-zh/) |

英文版是可执行契约；日文版与中文版共享它的 ID、路径、选项、骰子与素材，只有文本不同（`pnpm check:worlds` 校验）。原有旧模板和 playtest 版本已可恢复地移入 `archive/templates/pre-bilingual-2026-09-14/`，不会作为新游戏入口出现。分发与离线校验不代表世界已经通过真实 AI 通关。

正式内容直接维护在上述模板中。`tools/experiences/` 与 archive 仅用于历史测试和实验 fixture；不要把旧编译器产物重新放回正式模板列表。玩家存档、密钥和运行缓存继续忽略，模板更新不会自动迁移旧存档。
