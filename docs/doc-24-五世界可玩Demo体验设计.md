...
```mermaid
flowchart LR
    A["221B<br/>Watson 把信交给 Holmes"] --> B["拿起沾群青的黄铜画筒盖"]
    B --> C["人物案卷桌<br/>选择报社或停尸房"]
    C --> D["出示并连接三类证据<br/>物证 / 时间 / 手法"]
...
| 2 | 福尔摩斯 | Holmes 最后的物理动作是什么？结算做一主一变，还是三结局？ | A：扣回黄铜盖；一主一变 |
