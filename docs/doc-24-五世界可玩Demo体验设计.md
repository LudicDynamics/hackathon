...
|---|---|---|---|
| 雾坞镇 | 对证与提出第二艘船；本局线索决定雾外方向 | 雾退后的一条路、新城镇第一眼、当地一人和首个问题 | 1 个主要生成段；可选继续进城 |
| 福尔摩斯 | 玩家用自己的证据链推断、设局；不让 AI 换掉固定真相 | 沿已发现证据进入“不存在的街”，补现场人物与可用物 | 最多 1 段；不为生图额外造案件 |
| 时间线 | 玩家自由写传真，Writer 把所得与失去物化 | 同一地点的新现在：陈设、人物处境与 Chalk 随改写改变 | 1 个重点对照段；中间不每次重生整图 |
| 初雪 | 赴约时引用玩家原话，写出另一处缺席、记忆与信 | 短结算后玩家主动找避雪的小地方，遇见新人物 | 主线 1 次文本生成 + 可选 1 次新环境生成 |
...
```mermaid
flowchart LR
    A["0 级导入：事务所<br/>拿起调查人铜徽"] --> B["1 级地点主视图：港城图<br/>选择无人船 / 工坊 / 灯塔"]
