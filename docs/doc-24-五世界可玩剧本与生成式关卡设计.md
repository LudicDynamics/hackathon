# doc-24 五世界可玩剧本与生成式关卡设计（讨论稿）

> 状态：**共同讨论中（2026-09-12）**。玩家身份、世界真相和已有角色以 `worldlines-canvas/stack/worlds/*.json` 为参考；视觉以 `worldlines-assets/worlds/*-demo/` 为参考。本文只负责五个世界的主观体验、剧本关卡、高潮 / 结局与动态生长，不代替协议、冲刺或多模态文档。
