...
1. **0:00 - 0:30【世界内导言·我是谁】**：
   - 暴雨中的书桌已经在活动：窗外雨声、壁炉微光、煤气灯和纸面视差同时建立 Baker Street 的空间感；
   - 玩家看见 Watson 的委托信。信中同时交代玩家的身份关系、当前事件和不行动的代价；
...
3. **1:30 - 2:15【角色记忆·这里的人认识我】**：
   - 玩家点开 Watson，进入遮罩式特写；Watson 不重复任务说明，而是直接回应玩家刚才拿起的证物、掷骰结果和推断方向；
   - 玩家作出一个承诺或追问，Watson 把它写入双方的持久关系，并把新地点的风险与玩家个人联系起来。
