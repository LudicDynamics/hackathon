...
- 文档：`docs/perform/00`–`06`（全文）、`docs/gameplay/doc-19`（全文）、`docs/ui/前端改造计划.md:201-380/426-460`、`docs/ui/doc-06-演出与交互设计.md:1-120`、`docs/product/doc-03-文案语言.md:69/160`、`docs/tools/09-link与arrange.md:513/598-615/800`、`docs/tools/10-组件注册表与get-component-show.md:150-160/225/347-360/538-546/727-735`、`docs/tools/12-工具注册与路由统一.md:320-330/565-610`、`docs/development/后端实现计划.md:205-215`、`docs/wiring/00-共同上下文.md:28-36`。
