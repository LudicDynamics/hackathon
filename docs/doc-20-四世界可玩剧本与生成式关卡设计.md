...
> 状态：**方向草案**；以原创案件承载体验，既有 `templates/holmes-world` 可作为实现起点。
...
这意味着“四个设计”不能直接等同于“现有四个模板”，也不能用“四选三”提前取消其中一个。需要先明确四个世界分别怎样落在现有或新增模板上，再安排实现深度，避免目录 id、`world.json`、角色 home 和 opening 文件一起反复迁移。
