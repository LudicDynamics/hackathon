...
导言必须承担三种信息职责，但**不要求固定为三个物体**。下表只是对现有协议的叙事组装，不新建“身份纸 / 事件纸 / 信物纸”的 schema：玩家身份与进度继续复用 `player/` 与开场 chalk（doc-05 §2.1 / §8，现有 `holmes-world` 模板；**2026-09-12：journal 已撤销**，原先由它承担的部分一律落回所在层的 chalk，见 doc-12 文末），世界事件由开场 chalk / Chalk 承载，信物与地点分别复用 note/item 和 Layer / Gate（doc-05 §3.1–§3.2）。“玩家身份的唯一字段”尚未定案，四世界试玩前不把它伪装成已有 schema。

| 导言职责 | 回答的问题 | 现有真相源 | 可见载体 |
|---|---|---|---|
| **身份交接** | 我是谁，我与谁有关 | `player/README.md` + 导言层的开场 chalk | 身份卡、旧照片、任命书、角色对我的称呼 |
| **事件动机** | 发生了什么，我为什么要行动 | 导言层的开场 chalk + Chalk | 委托信、噩耗、事故记录、未兑现的约定 |
...
| **持久事实** | 玩家行动、骰子结果、持有物、承诺、角色关系、已生成地点与板书 | 让世界持续变化，让角色真正认识玩家，让后续内容继承因果 |
