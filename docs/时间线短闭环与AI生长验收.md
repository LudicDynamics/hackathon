...
> 2026-09-13 定案：一个世界、三个时间节点；1994／1995 同一店构图、日夜两版，2024 原路径呈现改写前后两种状态。零级按最新反馈恢复雨夜书桌。[六世界总览](六世界短闭环与AI生长验收.md)。本轮修改分支线体验版，不改初雪、不迁移旧存档、不改引擎。
...
|---|---|---|
| 1994-12-31 · 送修日 | 阳光店内、女孩、坏青蛙、送修票 | 次日十点领取；八点半从河对岸出发、经过东桥；店有家庭联系方式；也可走上游车道桥送货 |
...
1994 与1995 不制造两套装修，以日夜光线、日期标题、人物、物件和 Chalk 区分。幼年女孩复用 Ryo 立绘；成年女孩使用已完成白底人物画，由作家扮演的实体 note 展示，不伪造未注册角色按钮，也不提前出现在原线。
...
零级恢复 `assets/scenes/intro.webp` 与对应微动；1994 用 `shop-daylight.webp`，1995 用 `tonight.webp`。2024原线用已完成 `future-original.webp`，无不匹配的旧微动；成功后地点主视图换 `future-restored.webp`，进入店内复用用户喜欢的 `tonight.webp`，成年人物卡用 `assets/characters/ryo-adult.webp`。原线与IF线外观同构图，室内是另一镜头；雪中白昼到店内夜灯由Chalk交代时间经过。资产齐备不代表已经完成本局救济，未来文件仍必须由实际RP产生。详见 [素材接入](assets/分支线三时刻素材工单.md)。本轮不调用生图 API。
...
| 新图与成年人物正式素材 | **已接入模板**；图像可用，成年实体与成功场景仍待本局实际行动触发 |
