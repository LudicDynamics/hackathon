...
dice_outcomes:
  ...
  - min: 18
    max: 20
    text: 核心だけでなく、次に確かめる手順まで見えた。新しい右手の包帯、群青の袖口、事件前に届いた絵。ウェインを重点的に調べる根拠になるが、怪我だけで逮捕はできない。 原本を示して質問すれば、推測と証言を分けて確かめられる。
    options:
      - id: read-clue
        label: 手掛かりを読む
        action:
    ...
    rewards:
      - path: world/london-map/print-shop/illustration-room/investigation-great-success.md
        title: 核心を記した覚え書き
        body: 核心だけでなく、次に確かめる手順まで見えた。新しい右手の包帯、群青の袖口、事件前に届いた絵。ウェインを重点的に調べる根拠になるが、怪我だけで逮捕はできない。 原本を示して質問すれば、推測と証言を分けて確かめられる。
---
