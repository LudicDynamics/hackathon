...
dice_outcomes:
  ...
  - min: 18
    max: 20
    text: 核心だけでなく、次に確かめる手順まで見えた。イーディスは架空の住所で反応を試した。そこへ人を呼ぶ計画ではない。誰へ訂正が渡ったかを追おう。 原本を示して質問すれば、推測と証言を分けて確かめられる。
    options:
      - id: read-clue
        label: 手掛かりを読む
        action:
    ...
    rewards:
      - path: world/london-map/edith-room/investigation-great-success.md
        title: 核心を記した覚え書き
        body: 核心だけでなく、次に確かめる手順まで見えた。イーディスは架空の住所で反応を試した。そこへ人を呼ぶ計画ではない。誰へ訂正が渡ったかを追おう。 原本を示して質問すれば、推測と証言を分けて確かめられる。
---
