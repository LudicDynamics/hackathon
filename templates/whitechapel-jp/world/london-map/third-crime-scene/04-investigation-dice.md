...
dice_outcomes:
  ...
  - min: 18
    max: 20
    text: 核心だけでなく、次に確かめる手順まで見えた。椅子と帽子まで同じ。偶然ではなく、誰かが絵に合わせて現場を配置した疑いがある。群青と右手の痕跡を画家に確かめよう。 原本を示して質問すれば、推測と証言を分けて確かめられる。
    options:
      - id: read-clue
        label: 手掛かりを読む
        action:
    ...
    rewards:
      - path: world/london-map/third-crime-scene/investigation-great-success.md
        title: 核心を記した覚え書き
        body: 核心だけでなく、次に確かめる手順まで見えた。椅子と帽子まで同じ。偶然ではなく、誰かが絵に合わせて現場を配置した疑いがある。群青と右手の痕跡を画家に確かめよう。 原本を示して質問すれば、推測と証言を分けて確かめられる。
---
