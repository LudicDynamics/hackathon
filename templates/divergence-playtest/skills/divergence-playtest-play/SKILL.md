...
1994と1995の bg は同じ assets/scenes/tonight.webp。年月日、人物、蛙、署名欄で違いを見せる。2024の二状態も同構図が目標。画像は worldlines-assets で後から制作する。この Mock では generate_image を呼ばず、架空の画像パスを書かない。文字結果を先に完成し、画像がなくても読める。1–2分は生成体験予算で速度保証ではない。
