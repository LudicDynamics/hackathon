...
dice_outcomes:
  ...
  - min: 18
    max: 20
    text: 核心だけでなく、次に確かめる手順まで見えた。擦り跡は満潮より高い。水位だけでなく、別の船が横から押した可能性を調べられる。 原本を示して質問すれば、推測と証言を分けて確かめられる。
    options:
      - id: read-clue
        label: 手掛かりを読む
        action:
    ...
    rewards:
      - path: world/harbor-chart/seventh-berth/investigation-great-success.md
        title: 核心を記した覚え書き
        body: 核心だけでなく、次に確かめる手順まで見えた。擦り跡は満潮より高い。水位だけでなく、別の船が横から押した可能性を調べられる。 原本を示して質問すれば、推測と証言を分けて確かめられる。
---
