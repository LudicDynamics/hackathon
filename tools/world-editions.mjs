...
export const editionFamilies = [
  ...
  { base: 'firstsnow', source: 'first-snow-jp-playtest', en: 'First Snow Radio', ja: '初雪ラジオ' },
...
export const editionId = (family, locale) => family.base === 'firstsnow' && locale === 'ja' ? 'first-snow-jp' : family.base + (locale === 'ja' ? '-jp' : '');
