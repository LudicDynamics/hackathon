...
const characterCard = (characterId, title, role, body, avatar) => fm({
  type: 'character', characterId, title, role, ...(avatar ? { avatar } : {}),
}, body);
...
const worlds = [
  {
    ...
    files: {
      ...
      'world/harbor-chart/seventh-berth/silver-kite.md': characterCard('silver-kite', 'Silver Kite', 'Elven knight · guarding the gangplank', '“The ship was not empty. What it carried has already come ashore. I will say that only once.”', 'assets/characters/silver-kite.webp'),
      ...
      'world/harbor-chart/workshop/vera.md': characterCard('vera', 'Vera', 'Mechanic · repaired the ship', '“Investigator! A watch or the truth? I charge silver for the first. For the second—you must stay and talk.”', 'assets/characters/vera.webp'),
      ...
      'world/harbor-chart/old-lighthouse/old-mo.md': characterCard('old-mo', 'Old Mo', 'Lighthouse keeper · on duty that night', '“Talk up here. The wind hears everything below. Did you bring a drink? Never mind.”', 'assets/characters/old-mo.webp'),
  ...
  },
  {
    ...
    files: {
      ...
      'world/watson.md': characterCard('watson', 'Dr. John Watson', 'Physician · holding the morning post', '“Three letters, all delivered this morning. Two are bills. The third—you should open yourself. Lestrade even pressed the wax crooked.”', 'assets/characters/watson.webp'),
      ...
      'world/case-board/watson.md': characterCard('watson', 'Dr. John Watson', 'Physician · your companion', '“Steady, Holmes. You have stared at these faces for four hours. Tell me whom you would cross out first.”', 'assets/characters/watson.webp'),
      'world/case-board/edith.md': characterCard('edith', 'Edith Vale', 'Suspect · novelist', 'Missing for two weeks, changing lodgings three times. Her last manuscript changed one address to a street that does not exist.'),
      'world/case-board/wayne.md': characterCard('wayne', 'Arthur Wayne', 'Suspect · illustrator', 'Receives manuscripts seven days early. Recently began drawing left-handed, claiming a right-wrist injury. Ultramarine marks his cuff.'),
      'world/case-board/blackburn.md': characterCard('blackburn', 'Mr. Blackburn', 'Suspect · editor', 'All manuscripts pass through him. Every proof is locked in his desk. His alibis are club receipts issued by his own account.'),
      'world/case-board/tom.md': characterCard('tom', 'Tom Hale', 'Suspect · typesetter', 'Literate, ink-blackened, and simple in manner. His shift ledger places him beside the machines during every murder.'),
      ...
      'world/case-board/fleet-street-press/porter.md': characterCard('porter', 'Ned Porter', 'Crime reporter · informant', '“Mr. Holmes in person? The register is yours. When the Ripper falls, leave me the exclusive—Watson promised.”'),
  ...
  },
  {
    ...
    files: {
      ...
      'world/tokiwa-electrics/1994-11-02/ryo-child.md': characterCard('ryo-child', 'Ryo Tokiwa · Age 7', 'Shopkeeper’s daughter', '“What are you buying? Dad is repairing a radio in the back. Your clothes look strange—are they from the future?”', 'assets/characters/ryo-child.webp'),
      ...
      'world/tokiwa-electrics/tonight/shopkeeper.md': characterCard('shopkeeper', 'Mr. Tokiwa', 'Second-generation proprietor', '“The demolition notice is on the door, and still you came in. Look around. Nothing here knows what year it is.”', 'assets/characters/shopkeeper.webp'),
  ...
  },
  {
    ...
    files: {
      ...
      'world/nanami.md': characterCard('nanami', 'Nanami', 'Host · between songs', '“Ninety seconds before the next track. Guess whose song is first in the request box tonight?”', 'assets/characters/nanami.webp'),
      ...
      'world/winter-schedule/radio-studio/nanami.md': characterCard('nanami', 'Nanami', 'Host · classmate', '“Ninety seconds before the next song. Hey, Director—what happens to this program after graduation?”', 'assets/characters/nanami.webp'),
      ...
      'world/winter-schedule/amber-cafe/sumi-yukimura.md': characterCard('sumi-yukimura', 'Sumi Yukimura', 'Singer · newly debuted', '“My manager gave me forty minutes. Could the first thirty-nine be about anything except work?”'),
...
for (const world of worlds) {
  ...
  const manifest = {
    ...
    characters: world.characters.map(({ id, home, role, avatar, description }) => ({ id, home, role, avatar, description })),
    createdAt: stamp,
    updatedAt: stamp,
  };
